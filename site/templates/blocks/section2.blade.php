<section class="bg-gray-50 py-12 md:py-24">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-20 items-center container mx-auto px-5 md:px-0">
        <div class="col-span-1 md:col-span-2 space-y-3 wow fadeInRight">
